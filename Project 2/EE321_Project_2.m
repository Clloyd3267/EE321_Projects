...
title('3D Plot of "gen\_data.csv"');
...
title('1D Plot of Reduced "gen\_data.csv"');
...
figure
scatter3(data(:,1),data(:,2),data(:,3));
title('3D Plot of "gen\_data2.csv"');
...
title('2D Plot of Reduced "gen\_data2.csv"');
...
% Read in data
data = readmatrix("gitkeystroke_data.csv");
...
figure
scatter(reconstructedData,zeros(size(reconstructedData)));
title('1D Plot of Reduced "keystroke\_data.csv"');
